...
Inertial Relativity and its key formula the Space-Time Equivalence (STE) hypothesize that there is a universal mathematical relationship between time and the spatial distribution of matter: The characteristic length scale factor that determines time dilation between any two physical systems about any respective axes is universally equal to the fifth root of the inverse ratio of their moments of inertia about the same axes. In our prior paper, we demonstrated this universality by arriving at General Relativity calculations with exact precision utilizing only principles of relativistic inertia. This paper closes the loop by exploring Inertial Relativity's mathematical relationship with General and Special Relativity. In the context of moment of inertia about an axis, we demonstrate that the STE is mathematically equivalent to Schwarzschild gravitational time dilation. In the context of linear inertia (mass), the STE states an inverse third root relationship with inertia (mass), which we demonstrate is mathematically equivalent to Lorentz time dilation. Via this exploration, we show that Special and General Relativity emerge as edge cases of the same underlying phenomenon, Inertial Relativity: Special Relativity at the extremes of velocity and General Relativity at the extremes of mass, unifying the two under a single universal relativistic framework.
...
where R is the mean radius about the selected axis.
    ...
    I prime = k to the fifth power I
...
For a uniform sphere, substituting I = 2 over 5M R squared and V = 4 over 3pi R cubed, this reduces to:
...
Setting R = r sub s (the Schwarzschild condition) and solving yields the DeGerlia Threshold: the universal constant of DeGerlia Compactness at which a system undergoes gravitational collapse:

    D sub crit = c squared over 2G = 6.73295 times 10 to the 26 kilograms per meter

The ratio of a system's DeGerlia Compactness to this threshold gives the time dilation directly:

    dtau over dt = 1 - D over D sub crit

Substituting D = M/R:

    dtau over dt = 1 - M over R times D sub crit

Section 3: The Space-Time Equivalence (STE)

The STE is the core universal equivalence stated by Inertial Relativity:

    k = the quantity of I sub 2 over I sub 1, to the 1-fifth
...
where M sub 1 and M sub 2 are the masses of the two systems.

Section 3.1: Relating Linear Scale Factor k to General Relativity
...
- Time dilation applies to all systems, not only uniform or spherically symmetric ones
...
The ratio I sub 1/I sub 2 = 32 = 2 to the fifth power confirms that moment of inertia scales as k to the fifth power under isometric scaling. Designating the larger sphere as the observer (System 1) and the smaller as the observed (System 2), the STE yields:
    ...
    k = the quantity of I sub 2 over I sub 1, to the 1-fifth = 0.4 over 12.8 to the 1-fifth = the quantity of 1 over 32, to the 1-fifth = 0.5

recovering the linear scale factor between the two systems. The resulting time dilation is:

    dtau over dt = the square root of the quantity 1 - k = the square root of the quantity 1 - 0.5 approximately equal to 0.707

Section 4: General and Special Relativity

Schwarzschild gravitational time dilation:

    dtau over dt = the square root of the quantity 1 - r sub s over R

where r sub s = 2G M/c squared is the Schwarzschild radius and R is the mean radius about the selected axis.
...
where M sub 1, M sub 2 are the masses and R sub 1, R sub 2 are the mean radii of each system about the selected axis. The geometric constant 2 over 5 cancels:

    k = the quantity of M sub 2 R sub 2 squared over M sub 1 R sub 1 squared, to the 1-fifth
...
This is equivalently expressed through inertial density or DeGerlia Compactness, since P is proportional to M/R and D = M/R. When mass is static, the ratio of either quantity reduces to the ratio of mean radii about the selected axis:

    k = P sub 1 over P sub 2 = D sub 1 over D sub 2 = R sub 2 over R sub 1 = r sub s over R

When compared against the DeGerlia Threshold D sub crit = 6.73295 times 10 to the 26 kilograms per meter:
...
I is proportional to M R squared where R is the mean radius about the selected axis.

Case 1: Static Mass M sub 1 = M sub 2,\ R sub 1 > R sub 2
...
Example (Case 1): Gravitational time dilation compares a system at a given mass and radius to that same mass at arbitrarily large radius, where there is no time dilation. Under the STE, this is a static-mass comparison between two uniform spheres. S sub 1 has the mass and mean radius of the Sun (M = 1.989 times 10 to the 30 kilograms, R sub 1 = 6.957 times 10 to the eighth power m). S sub 2 is the same mass compressed to just above the Schwarzschild radius (r sub s = 2953.34 m), at R sub 2 = 2954 m. R sub 2 is chosen above r sub s because at R = r sub s the system is at gravitational collapse, where dtau/dt = 0; the comparison requires a physical, non-collapsed system.
    ...
    dtau over dt = the square root of the quantity 1 - k = the square root of the quantity 1 - 4.24608 times 10 to the negative 6 = 0.99999787696

Confirmation: Schwarzschild gravitational time dilation at R sub 1:

    dtau over dt = the square root of the quantity 1 - 2G M over R sub 1 c squared = 1 - 2.65504 times 10 to the 20 over 6.25295 times 10 to the 25
    = the square root of the quantity 1 - 4.24605 times 10 to the negative 6 = 0.99999787697

Case 2: Static Radius R sub 1 = R sub 2,\ M sub 1 > M sub 2
...
Since k = the quantity of k sub 2/k sub 1, to the 1-third where k sub i = D sub i/D sub crit and D = M/R:

    k sub 1 = M sub 1/R over D sub crit = 10 to the 30/10 to the eighth power over 6.73295 times 10 to the 26 = 1.48523 times 10 to the negative 5
    k sub 2 = k sub 1 times k cubed = 1.48523 times 10 to the negative 5 times 0.01 cubed
    = 1.48523 times 10 to the negative 5 times 10 to the negative 6 = 1.48523 times 10 to the negative 11
    dtau over dt = the quantity the square root of the quantity 1 - k sub 1 over the quantity the square root of the quantity 1 - k sub 2 = the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 5 over the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 11 = 0.9999925737

Confirmation: Since D sub crit = c squared/2G, we have D/D sub crit = 2G M/R c squared. Gravitational time dilation:

    dtau sub 1 / dt over dtau sub 2 / dt = the quantity the square root of the quantity 1 - 2G M sub 1 over R c squared over the quantity the square root of the quantity 1 - 2G M sub 2 over R c squared = the quantity the square root of the quantity 1 - D sub 1 over D sub crit over the quantity the square root of the quantity 1 - D sub 2 over D sub crit
    = the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 5 over the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 11 = 0.9999925737

Case 3: Constant Density M is proportional to R cubed,\ R sub 1 > R sub 2
...
Since D = M/R is proportional to R squared at constant density, k sub 2/k sub 1 = R sub 2/R sub 1 squared = k squared where k sub i = D sub i/D sub crit:

    k sub 1 = M sub 1/R sub 1 over D sub crit = 10 to the 30/10 to the eighth power over 6.73295 times 10 to the 26 = 1.48523 times 10 to the negative 5
    k sub 2 = k sub 1 times k squared = 1.48523 times 10 to the negative 5 times 0.1 squared
    = 1.48523 times 10 to the negative 5 times 10 to the negative 2 = 1.48523 times 10 to the negative 7
    dtau over dt = the quantity the square root of the quantity 1 - k sub 1 over the quantity the square root of the quantity 1 - k sub 2 = the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 5 over the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 7 = 0.99999264807

Confirmation: Since D sub crit = c squared/2G, we have D/D sub crit = 2G M/R c squared. Gravitational time dilation:

    dtau sub 1 / dt over dtau sub 2 / dt = the quantity the square root of the quantity 1 - 2G M sub 1 over R sub 1 c squared over the quantity the square root of the quantity 1 - 2G M sub 2 over R sub 2 c squared = the quantity the square root of the quantity 1 - D sub 1 over D sub crit over the quantity the square root of the quantity 1 - D sub 2 over D sub crit
    = the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 5 over the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 7 = 0.99999264807

Case 4: Constant Inertia M sub 1 R sub 1 squared = M sub 2 R sub 2 squared
...
When inertia is conserved, k = 1 and no relative time dilation exists between the two systems.

General Case M sub 1 not equal to M sub 2,\ R sub 1 not equal to R sub 2,\ M sub 1 not equal to R sub 1 cubed,\ M sub 2 not equal to R sub 2 cubed
...
Normalizing each system to D sub crit = 6.73295 times 10 to the 26 kilograms per meter, where k sub i = D sub i/D sub crit and D = M/R:

    k sub 1 = M sub 1/R sub 1 over D sub crit = 10 to the 27/10 to the eighth power over 6.73295 times 10 to the 26 = 1.48523 times 10 to the negative 8
    k sub 2 = M sub 2/R sub 2 over D sub crit = 10 to the 24/10 to the seventh power over 6.73295 times 10 to the 26 = 1.48523 times 10 to the negative 10
    dtau over dt = the quantity the square root of the quantity 1 - k sub 1 over the quantity the square root of the quantity 1 - k sub 2 = the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 8 over the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 10
    = 0.99999999264810

Confirmation: Since D sub crit = c squared/2G, we have D/D sub crit = 2G M/R c squared. Gravitational time dilation:

    dtau sub 1 / dt over dtau sub 2 / dt = the quantity the square root of the quantity 1 - 2G M sub 1 over R sub 1 c squared over the quantity the square root of the quantity 1 - 2G M sub 2 over R sub 2 c squared = the quantity the square root of the quantity 1 - D sub 1 over D sub crit over the quantity the square root of the quantity 1 - D sub 2 over D sub crit
    = the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 8 over the quantity the square root of the quantity 1 - 1.48523 times 10 to the negative 10 = 0.99999999264810
...
1. T. D. DeGerlia, The Universe of Light - Exploring our Universe through the Lens of the Law of Space-Time Equivalence, DEC, 2025, DOI: 10.55277/ResearchHub.pi9yjshm
2. T. D. DeGerlia, Introducing Inertial Density and Characterizing the Schwarzschild Condition as a Constant Threshold of Mass over Radius (m/r), DEC, 2025, DOI: 10.55277/researchhub.0e0cgoor
3. A. Einstein, Sitzungsberichte der Königlich Preußischen Akademie der Wissenschaften (Berlin), 1915, 844–847
4. A. Einstein, Annalen der Physik, 1905, 17, 891–921
5. K. Schwarzschild, Sitzungsberichte der Königlich Preußischen Akademie der Wissenschaften (Berlin), 1916, 189–196
6. R. P. Kerr, Physical Review Letters, 1963, 11, 237–238
7. H. Goldstein, C. Poole and J. Safko, Classical Mechanics, Addison-Wesley, 3rd edn, 2002, pp. 70–71
8. D. V. Widder, Advanced Calculus, Dover Publications, 2nd edn, 1961, pp. 20–22
