...
\begin{equation}
L' = kL \quad \text{where } L \text{ is the characteristic length of the system, and } k \text{ is the linear scale factor}
\end{equation}

\begin{equation}
M' = k^3 \quad \text{where mass is } M \text{ and } k \text{ is linear scale factor}
\end{equation}

\begin{equation}
I' = k^5I \quad \text{where } I \text{ is the moment of inertia about a selected axis; } k \text{ is the linear scale factor.}
\end{equation}

\begin{equation}
I_{lin}' = M' = k^3M \quad \text{where } I_{lin} \text{ is linear inertia (mass); } k \text{ is the linear scale factor.}
\end{equation}
