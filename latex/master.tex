...
\vspace{0.3cm} & \vspace{0.3cm} \\
 ...
 \vspace{0.3cm} & \vspace{0.3cm} \\
\includegraphics{head_foot/dates} & \noindent\normalsize{ABSTRACT: Inertial Relativity and its key formula the Space-Time Equivalence (STE)\cite{degerlia2025universe}, states that there is a universal mathematical relationship between space, time, and matter: The ratio of clock rates between any two physical systems about ANY resxpecrtive axes is universally equal to the fifth root of the inverse ratio of their moments of inertia about the same axes. We've demonstrated this universality by arriving at General Realtivity calculations with exact precision utilizing only principles of relativistic inertia \cite{degerlia2025}. This paper closes the loop by demonstrtating Inertial Relativity's mathematical relationship with General and Special Relativity. We demonstrate that the STE is mathematically equivalent to Schwarzschild gravitational time dilation. In the context of linear inertia (mass), the STE states an inverse third root relationship with inertia (mass), which we will demonstrate is mathematically equivalent to Lorentz time dilation. Via this exploration, we show that Special and General Relativity emerge as edge cases of the exact same time dilation, one at the extremes of velocity and the other at the extremes of mass, thus unifying the two under a single universal framework: The Theory of Inertial Relativity.}
