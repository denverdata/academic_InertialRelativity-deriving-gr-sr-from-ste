...
T_1/T_2 = K_i = (I_2/I_1)^{(1/5)}
\end{equation}
where $T_1$ and $T_2$ are the clock rates of any two systems about any respective axes, and $I_1$ and $I_2$ are their moments of inertia about those same axes. $K_i$ is the inertial scale factor between the two systems about those same axes. 
For linear (non-rotational) systems, inertia reduces to mass and the exponent becomes 1/3:
\begin{equation}
T_1/T_2 = K_i (M_2/M_1)^{(1/3)}
\end{equation}
where $T_1$ and $T_2$ are the clock rates of any two systems along any respective linear path, and $M_1$ and $M_2$ are their respective masses. $K_i$ is the inertial scale factor between the two systems along those same paths.

These two equations demonstrate that the relative pace of time for a system is:
