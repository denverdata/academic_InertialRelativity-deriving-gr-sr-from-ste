...
$I = MR^2$ where $R$ is the mean radius about the selected axis.

\textbf{Case 1: Static Mass} $(M_1 = M_2,\ R_1 \neq R_2)$

\begin{equation}
k = \left(\frac{I_2}{I_1}\right)^{1/L} = \left(\frac{M R_2^2}{M R_1^2}\right)^{1/L} = \left(\frac{R_2^2}{R_1^2}\right)^{1/2} = \frac{R_2}{R_1}
\end{equation}

\textbf{Case 2: Static Radius} $(R_1 = R_2,\ M_1 \neq M_2)$

\begin{equation}
k = \left(\frac{I_2}{I_1}\right)^{1/L} = \left(\frac{M_2 R^2}{M_1 R^2}\right)^{1/L} = \left(\frac{M_2}{M_1}\right)^{1/3}
\end{equation}
