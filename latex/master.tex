...
The fifth root relationship therefore holds universally: for any two systems abput any two respective axes, the characteristic length scale factor that determines time dilation is the fifth root of the inverse ratio of their moments of inertia about those same axes. Isometric scaling establishes the exponent (Equation~\ref{eq:inertia_scaling}).
