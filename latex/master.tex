...
To confirm internal consistency, we verify that the general STE decomposes exactly into its special-case components applied sequentially. If the general form is consistent, computing $k$ directly from $(I_2/I_1)^{1/5}$ must produce the same result as computing the mass and radius contributions independently and multiplying them.
