<p align="center">
<b>DERIVING RELATIVISTIC TIME FROM INERTIA: A UNIFIED ORIGIN OF THE LORENTZ AND SCHWARZSCHILD METRICS</b>
</p>
...
When radius is shared between two systems, the STE reduces to (see Appendix A):
...
<p align="center">
<b>Figure 1.</b> Isometric scaling of a uniform sphere by factor <i>k</i>=2. Mass scales as <i>k</i><sup>3</sup>, moment of inertia as <i>k</i><sup>5</sup>, and the clock rate ratio follows directly from the STE.
</p>
...
From Equation 17, when $M_1 = M_2$, the STE reduces to (see Appendix A for derivation):
...
From Equation 17, when $R_1 = R_2$, the STE reduces to (see Appendix A):
...
When density is held constant, $M \propto R^3$, and the STE reduces to a pure linear scale ratio (see Appendix A):
...
<p align="center">
<b>Table A1.</b> Degree of homogeneity <i>L</i> for physical quantities under isometric scaling.
</p>
...
[1] Einstein, A. (1905) "Zur Elektrodynamik bewegter Korper", *Annalen der Physik*, Vol. 17, pp891-921.

[2] Einstein, A. (1915) "Die Feldgleichungen der Gravitation", *Sitzungsberichte der Koniglich Preussischen Akademie der Wissenschaften (Berlin)*, pp844-847.

[3] Schwarzschild, K. (1916) "Uber das Gravitationsfeld eines Massenpunktes nach der Einsteinschen Theorie", *Sitzungsberichte der Koniglich Preussischen Akademie der Wissenschaften (Berlin)*, pp189-196.

[4] Kerr, R. P. (1963) "Gravitational Field of a Spinning Mass as an Example of Algebraically Special Metrics", *Physical Review Letters*, Vol. 11, pp237-238.

[5] DeGerlia, T. D. (2025) "Introducing Inertial Density and Characterizing the Schwarzschild Condition as a Constant Threshold of Mass over Radius (m/r)", *ResearchHub*, DOI: 10.55277/researchhub.0e0cgoor.

[6] Euler, L. (1755) *Institutiones Calculi Differentialis*, Academiae Imperialis Scientiarum Petropolitanae.

[7] DeGerlia, T. D. (2025) "The Universe of Light - Exploring our Universe through the Lens of the Law of Space-Time Equivalence", *ResearchHub*, DOI: 10.55277/ResearchHub.pi9yjshm.

## AUTHORS

Thomas Damon DeGerlia is the principal of DeGerlia Expert Consulting. He holds a B.S. in chemistry and mathematics from Metropolitan State University of Denver and has completed graduate work in chemistry and software engineering at the University of Colorado.
