...
\usepackage{graphicx}
\usepackage{booktabs}
\usepackage{courier} % Courier New for emails
\usepackage{hyperref}
\usepackage{setspace}
\usepackage{titlesec}
\usepackage{enumitem}
...
% Section formatting: 14pt bold small caps, 6pt after
\titleformat{\section}
  {\normalfont\fontsize{14}{16}\bfseries\scshape}
  {\thesection.}{0.5em}{}
\titlespacing*{\section}{0pt}{12pt}{6pt}

% Subsection formatting: 12pt bold, 6pt after
\titleformat{\subsection}
  {\normalfont\fontsize{12}{14}\bfseries}
  {\thesubsection.}{0.5em}{}
\titlespacing*{\subsection}{0pt}{12pt}{6pt}

% Subsubsection formatting: 11pt bold, 6pt after
\titleformat{\subsubsection}
  {\normalfont\fontsize{11}{13}\bfseries}
  {\thesubsubsection.}{0.5em}{}
\titlespacing*{\subsubsection}{0pt}{12pt}{6pt}

% Caption formatting: 11pt TNR, centered
\captionsetup{font={normalsize},justification=centering,labelsep=period}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{ste_example.pdf}
...
From Equation~\ref{eq:k_simplified}, when $M_1 = M_2$, the STE reduces to (see Appendix~A for derivation):
\begin{equation}
...
From Equation~\ref{eq:k_simplified}, when $R_1 = R_2$, the STE reduces to (see Appendix~A):
\begin{equation}
k = \left(\frac{M_2}{M_1}\right)^{1/3}
\end{equation}
...
\begin{table}[H]
\centering
\caption{Degree of homogeneity $L$ for physical quantities under isometric scaling.}
\begin{tabular}{lc}
\toprule
Ratio & $L$ \\
\midrule
...
\section*{Authors}
\textbf{Thomas Damon DeGerlia} is the principal of DeGerlia Expert Consulting. He holds a B.S. in chemistry and mathematics from Metropolitan State University of Denver and has completed graduate work in chemistry and software engineering at the University of Colorado.
